  ...
  return (
    <div className="methodebox">
      <p className="methodebox__p">
        ...
        transparente et régulière. <br />
        En nous adaptant rapidement aux changements et en privilégiant la
        livraison incrémentielle, nous nous assurons de répondre de manière
        efficace aux besoins évolutifs de nos clients tout en garantissant la
